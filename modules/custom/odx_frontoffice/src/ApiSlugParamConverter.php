 ...
 * @code
 * odx_frontoffice.api_slug_parameter_converter:
 *   path: example/{record}
 *   defaults:
 ...
 */
class ApiSlugParamConverter implements ParamConverterInterface {
  ...
  /**
   * Constructs a new ApiSlugParamConverter.
   *
  ...
  public function convert($value, $definition, $name, array $defaults) {
    $alias = \Drupal::service('path_alias.manager')->getPathByAlias('/api/'. $value);
    if ($alias) {
  ...
  public function applies($definition, $name, Route $route) {
    return !empty($definition['type']) && $definition['type'] == 'api_slug';
  }
